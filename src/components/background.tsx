...
import bg2 from "@/assets/background_2.jpg";
...
const backgrounds: BackgroundItem[] = [
  { src: bg1, position: "30% 40%", source: "https://pixiv.net/artworks/136849830" },
  { src: bg2, position: "64% 45%", source: "https://x.com/roro046/status/1983491023604212009" },
  { src: bg3, position: "33% 45%", source: "https://pixiv.net/artworks/147092236" },
];
 ...
 */
function fade(img: HTMLImageElement | null, from: number, to: number) {
  if (!img) {
    return;
  }
