              ...
              <>
                ...
                <div className="relative mb-4">
                  ...
                  <input
                    ...
                    placeholder="搜索文章"
                    aria-label="搜索文章"
                    className="w-full rounded-md border bg-background/50 py-1.5 pl-8 pr-7 text-sm outline-none transition-colors focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30"
                  />
                  {search && (
                    <button
                      type="button"
                  ...
                  {yearGroups.map((group) => (
                    <Collapsible key={group.year} defaultOpen>
                      <CollapsibleTrigger className="group flex w-full items-center gap-1 rounded px-1 py-1 text-sm font-medium hover:bg-secondary/50">
                        ...
                        <span className="text-muted-foreground">({group.posts.length})</span>
                      </CollapsibleTrigger>
              ...
              >
                {([2, 3, 4] as const).map((lvl) => (
                  <button
                    ...
                    title={`最多显示到 H${lvl}`}
                    className={cn(
                      "h-5 w-5 rounded text-[10px] font-medium leading-none transition-colors",
                      maxLevel === lvl
                        ? "bg-primary text-primary-foreground"
